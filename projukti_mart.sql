...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 08, 2026 at 07:34 AM
...
INSERT INTO `orders` (`order_id`, `user_id`, `address_id`, `status`, `total_amount`, `order_date`) VALUES
(1, 5, 1, 'delivered', 12500.00, '2026-08-12 04:30:00'),
(2, 6, 2, 'delivered', 34999.00, '2026-08-15 09:20:00'),
(3, 7, 3, 'shipped', 104999.00, '2026-08-28 06:10:00'),
(4, 8, 4, '', 69999.00, '2026-09-01 11:00:00'),
(5, 9, 5, 'pending', 18500.00, '2026-09-05 05:15:00'),
(6, 10, 6, 'delivered', 2299.00, '2026-08-20 03:45:00');
...
INSERT INTO `products` (`product_id`, `category_id`, `seller_id`, `name`, `brand`, `model`, `description`, `price`, `stock_qty`, `status`, `created_at`) VALUES
(1, 4, 2, 'ASUS TUF Gaming A15', 'ASUS', 'FA507', 'Gaming laptop with Ryzen 7 processor and RTX graphics.', 119999.00, 8, 'active', '2026-09-08 05:34:06'),
(2, 4, 2, 'Lenovo LOQ 15', 'Lenovo', '15IRX9', 'Performance gaming laptop for gaming, coding and creative work.', 134999.00, 6, 'active', '2026-09-08 05:34:06'),
(3, 4, 3, 'Acer Nitro V 15', 'Acer', 'ANV15-51', 'Value-focused gaming laptop with 144Hz display.', 104999.00, 10, 'active', '2026-09-08 05:34:06'),
(4, 5, 2, 'Dell Inspiron 14', 'Dell', '5430', 'Compact business and productivity laptop with Core i5.', 84999.00, 12, 'active', '2026-09-08 05:34:06'),
(5, 5, 3, 'HP Pavilion 14', 'HP', '14-eh', 'Slim laptop for office work, study and everyday productivity.', 74999.00, 15, 'active', '2026-09-08 05:34:06'),
(6, 5, 4, 'Lenovo ThinkPad E14', 'Lenovo', 'Gen 6', 'Business laptop with durable chassis and excellent keyboard.', 92999.00, 9, 'active', '2026-09-08 05:34:06'),
(7, 6, 2, 'TechHub Creator PC', 'Custom', 'TH-CREATOR-01', 'Desktop workstation for programming, editing and productivity.', 109999.00, 5, 'active', '2026-09-08 05:34:06'),
(8, 6, 3, 'ByteZone Office PC', 'Custom', 'BZ-OFFICE-01', 'Balanced desktop PC for office applications and development.', 69999.00, 9, 'active', '2026-09-08 05:34:06'),
(9, 6, 4, 'Gadget World Home PC', 'Custom', 'GW-HOME-01', 'Affordable desktop for home, study and general use.', 54999.00, 11, 'active', '2026-09-08 05:34:06'),
(10, 7, 2, 'TechHub RTX Gaming PC', 'Custom', 'TH-GAME-01', 'High-performance gaming desktop with RTX graphics.', 179999.00, 4, 'active', '2026-09-08 05:34:06'),
(11, 7, 3, 'ByteZone Esports PC', 'Custom', 'BZ-ESPORT-01', '1080p high-refresh-rate gaming desktop.', 124999.00, 7, 'active', '2026-09-08 05:34:06'),
(12, 7, 4, 'Gadget World Starter Gaming PC', 'Custom', 'GW-GAME-01', 'Entry-level gaming desktop for popular esports titles.', 89999.00, 6, 'active', '2026-09-08 05:34:06'),
(13, 8, 2, 'Keychron K8 Pro', 'Keychron', 'K8P', 'Wireless mechanical keyboard with hot-swappable switches.', 12500.00, 18, 'active', '2026-09-08 05:34:06'),
(14, 8, 3, 'Logitech G Pro X TKL', 'Logitech', 'G-PRO-X-TKL', 'Tenkeyless wireless gaming keyboard with programmable controls.', 18500.00, 14, 'active', '2026-09-08 05:34:06'),
(15, 8, 4, 'Redragon K552 Kumara', 'Redragon', 'K552', 'Affordable mechanical keyboard with RGB backlighting.', 4500.00, 25, 'active', '2026-09-08 05:34:06'),
(16, 9, 2, 'Sony WH-1000XM5', 'Sony', 'WH1000XM5', 'Premium wireless noise-cancelling headphones.', 34999.00, 10, 'active', '2026-09-08 05:34:06'),
(17, 9, 3, 'JBL Tune 770NC', 'JBL', 'T770NC', 'Wireless noise-cancelling headphones with long battery life.', 12999.00, 16, 'active', '2026-09-08 05:34:06'),
(18, 9, 4, 'Anker Soundcore Q20i', 'Anker', 'Q20i', 'Comfortable wireless headphones with hybrid ANC.', 6999.00, 20, 'active', '2026-09-08 05:34:06'),
(19, 10, 2, 'UGREEN USB-C to USB-C 100W Cable', 'UGREEN', 'USBC100W', 'Durable USB-C cable suitable for fast charging and data transfer.', 1499.00, 40, 'active', '2026-09-08 05:34:06'),
(20, 10, 3, 'Baseus USB-C to HDMI Cable', 'Baseus', 'CAHUB-C', '4K HDMI connection from compatible USB-C devices.', 2299.00, 30, 'active', '2026-09-08 05:34:06'),
(21, 10, 4, 'Anker PowerLine III USB-C Cable', 'Anker', 'A8852', 'Reliable USB-C charging and data cable.', 1299.00, 35, 'active', '2026-09-08 05:34:06'),
(22, 11, 2, 'Rain Design mStand', 'Rain Design', 'mStand', 'Aluminum laptop stand designed to improve desk ergonomics.', 6999.00, 12, 'active', '2026-09-08 05:34:06'),
(23, 11, 3, 'UGREEN Adjustable Laptop Stand', 'UGREEN', 'LP451', 'Foldable adjustable stand for laptops and tablets.', 3299.00, 22, 'active', '2026-09-08 05:34:06'),
(24, 11, 4, 'Baseus Metal Desktop Stand', 'Baseus', 'SUZB', 'Compact metal stand for laptops and tablets.', 2499.00, 18, 'active', '2026-09-08 05:34:06');
...
--
ALTER TABLE `product_specs`
  MODIFY `spec_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=97;
