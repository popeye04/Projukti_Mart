...
<head>
    ...
    <title><?php echo isset($page_title) ? h($page_title) . ' - Projukti Mart' : 'Projukti Mart'; ?></title>
    ...
    <link rel="stylesheet" href="/Project/assets/css/style.css?v=2">
</head>
<body>
...
<header class="site-header">
    ...
    <div class="header-main">
        <a href="/Project/index.php" class="logo" aria-label="Projukti Mart home"><span class="logo-mark" aria-hidden="true"><svg viewBox="0 0 28 28" fill="none"><path d="M5 22V6h10a6 6 0 0 1 0 12h-5" stroke="currentColor" stroke-width="3.5"/><path d="M11 22V12h4" stroke="currentColor" stroke-width="3.5"/></svg></span><span class="logo-wordmark">Projukti<span>Mart</span></span></a>

        <form class="search-bar" action="/Project/search_results.php" method="GET" role="search">
            ...
            <ul id="searchSuggestions" class="search-suggestions" aria-label="Product suggestions" hidden></ul>
        </form>
        ...
        <div class="header-actions">
            ...
            <details class="account-menu">
                <summary>
                    ...
                    <?php echo isset($_SESSION['username']) ? h($_SESSION['username']) : 'Account'; ?>
                </summary>
                <ul>
                    <?php if (isset($_SESSION['username'])): ?>
                        <?php if (($_SESSION['role'] ?? '') === 'customer'): ?>
                        <li><a href="/Project/orders.php">My Orders</a></li>
                        <li><a href="/Project/profile.php">My Addresses</a></li>
                        <?php endif; ?>
                        ...
                        <?php endif; ?>
                        <li><a href="/Project/logout.php" class="logout-button">Logout</a></li>
                    <?php else: ?>
            ...
            <a href="/Project/cart.php" class="cart-link">
...
<script src="/Project/assets/js/search_suggestions.js" defer></script>
...
<script>
    ...
    document.addEventListener('DOMContentLoaded', () => {
        ...
        document.addEventListener('click', event => {
            ...
            const url = new URL(link.href);
            if (url.origin !== location.origin || !/^https?:$/.test(url.protocol) || !url.pathname.startsWith('/Project/')) return;
